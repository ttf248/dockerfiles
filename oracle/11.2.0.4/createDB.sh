...
lsnrctl start &&
dbca -initParams java_jit_enabled=false -silent -createDatabase -responseFile $ORACLE_BASE/dbca.rsp -redoLogFileSize 10 -datafileDestination /opt/oracle/oradata ||
...
sqlplus / as sysdba << EOF
   ...
   begin
   execute immediate 'alter database tempfile 1 resize 5G';
   OPEN c_cursor;
   ...
   WHILE c_cursor%FOUND LOOP
     ...
     execute immediate 'alter database datafile ' || v_fileid || ' resize 500M';
     end if;
